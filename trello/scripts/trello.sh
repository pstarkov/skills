...
#   get_action id=abc123
#   create_new_card idList=xyz name="My Card"
...
get_applications_compliance_data() {
...
delete_checkitem_from_checklist() {
...
delete_option_custom_field_dropdown() {
...
delete_organization_from_enterprise() {
...
delete_members_custom_board_background() {
...
delete_custom_board_background_member() {
...
remove_associated_google_apps_domain_from_workspace() {
...
delete_email_domain_restriction_on_who_can_be_invited_to_workspace() {
...
delete_webhook_created_by_token() {
...
remove_member_as_admin_from_enterprise() {
...
list_actions_summary_reactions() {
...
get_custom_field_items_for_card() {
...
get_members_who_have_voted_on_card() {
...
add_option_to_custom_field_dropdown() {
...
get_option_custom_field_dropdown() {
...
get_auditlog_data_for_enterprise() {
...
get_claimableorganizations_enterprise() {
...
bulk_accept_set_organizations_to_enterprise() {
...
get_pendingorganizations_enterprise() {
...
get_bulk_list_organizations_that_can_be_transferred_to_enterprise() {
...
get_whether_organization_can_be_transferred_to_enterprise() {
...
get_boards_that_member_belongs_to() {
...
get_boards_member_has_been_invited_to() {
...
get_custom_board_background_member() {
...
# Get a member's notification channel settings
get_members_notification_channel_settings() {
...
get_blocked_notification_keys_member_on_this_channel() {
...
get_organizations_member_has_been_invited_to() {
...
# Get the member who created the notification
get_member_who_created_notification() {
...
get_notifications_associated_organization() {
...
get_organizations_new_billable_guests() {
...
get_plugindata_scoped_to_organization() {
...
get_plugins_member_privacy_compliance() {
...
get_webhook_belonging_to_token() {
...
get_member_notification_is_about_not_creator() {
...
remove_member_from_organization_and_all_organization_boards() {
...
mark_cards_notifications_as_read() {
...
# Create a new Custom Field on a board.
create_new_custom_field_on_board() {
...
upload_new_boardbackground_for_member() {
...
create_custom_emoji_for_member() {
...
create_custom_sticker_for_member() {
...
create_saved_search_for_member() {
...
create_export_for_organizations() {
...
update_showsidebaractivity_pref_on_board() {
...
update_showsidebarboardactions_pref_on_board() {
...
update_idemaillist_pref_on_board() {
...
# Update an item in a checklist on a card.
update_checkitem_on_checklist_on_card() {
...
update_custom_field_item_on_card() {
...
update_member_to_be_admin_enterprise() {
...
decline_enterprisejoinrequests_from_one_organization_or_bulk_list_organizations() {
...
update_members_licensed_status() {
...
transfer_organization_to_enterprise() {
...
update_members_custom_board_background() {
...
update_position_boardstar_member() {
...
update_custom_board_background_member() {
...
update_blocked_notification_keys_member() {
...
# Update blocked notification keys of Member on a channel
# Update blocked notification keys of Member on a specific channel
update_blocked_notification_keys_member_channel() {
...
# Update blocked notification keys of Member on a channel
# Update blocked notification keys of Member on a specific channel
update_blocked_notification_keys_member_on_channel() {
...
deactivate_or_reactivate_member_organization() {
